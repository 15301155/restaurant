...
<body>
	...
	<div class="header-top">
		<div class="container">
			<div class="head-main">
				<a href="index.jsp"><img src="<%=path%>/images/logo-1.png" alt="" /></a>
			</div>
		</div>
	</div>
	<!--header-top-end-->
		...
		<div class="container">
			<div class="about-main">
				<div class="col-md-8 about-left">
					<div class="about-one">
						<p>Find The Most</p>
						<h3>Happy of the month</h3>
					</div>
					<div class="about-two">
					
						<a href="single.jsp"><img src="<%=path%>/images/c-1.jpg" alt="" /></a>
					...
					<div class="about-tre">
						<div class="a-1">
							<div class="col-md-6 abt-left">
								<a href="single.html"><img src="<%=path%>/images/c-3.jpg" alt="" /></a>
								<h6>Find The Most</h6>
							...
							<div class="col-md-6 abt-left">
								<a href="single.html"><img src="<%=path%>/images/c-4.jpg" alt="" /></a>
								<h6>Find The Most</h6>
								<h3><a href="single.html">Tasty Coffee</a></h3>
								<p>Vivamus interdum diam diam, non faucibus tortor consequat vitae. Proin sit amet augue sed massa pellentesque viverra. Suspendisse iaculis purus eget est pretium aliquam ut sed diam.</p>
								<label>May 29, 2015</label>
						...
						<div class="a-1">
							<div class="col-md-6 abt-left">
								<a href="single.html"><img src="<%=path%>/images/c-5.jpg" alt="" /></a>
								<h6>Find The Most</h6>
								<h3><a href="single.html">Tasty Coffee</a></h3>
								<p>Vivamus interdum diam diam, non faucibus tortor consequat vitae. Proin sit amet augue sed massa pellentesque viverra. Suspendisse iaculis purus eget est pretium aliquam ut sed diam.</p>
								<label>May 29, 2015</label>
							...
							<div class="col-md-6 abt-left">
								<a href="single.html"><img src="<%=path%>/images/c-6.jpg" alt="" /></a>
								<h6>Find The Most</h6>
								<h3><a href="single.html">Tasty Coffee</a></h3>
								<p>Vivamus interdum diam diam, non faucibus tortor consequat vitae. Proin sit amet augue sed massa pellentesque viverra. Suspendisse iaculis purus eget est pretium aliquam ut sed diam.</p>
								<label>May 29, 2015</label>
						...
						<div class="a-1">
							<div class="col-md-6 abt-left">
								<a href="single.html"><img src="<%=path%>/images/c-7.jpg" alt="" /></a>
								<h6>Find The Most</h6>
								<h3><a href="single.html">Tasty Coffee</a></h3>
								<p>Vivamus interdum diam diam, non faucibus tortor consequat vitae. Proin sit amet augue sed massa pellentesque viverra. Suspendisse iaculis purus eget est pretium aliquam ut sed diam.</p>
								<label>May 29, 2015</label>
							...
							<div class="col-md-6 abt-left">
								<a href="single.html"><img src="<%=path%>/images/c-8.jpg" alt="" /></a>
								<h6>Find The Most</h6>
								<h3><a href="single.html">Tasty Coffee</a></h3>
								<p>Vivamus interdum diam diam, non faucibus tortor consequat vitae. Proin sit amet augue sed massa pellentesque viverra. Suspendisse iaculis purus eget est pretium aliquam ut sed diam.</p>
								<label>May 29, 2015</label>
				...
				<div class="col-md-4 about-right heading">
					<div class="abt-1">
						<h3>ABOUT US</h3>
						<div class="abt-one">
							<img src="<%=path%>/images/c-2.jpg" alt="" />
						...
						<h3>YOU MIGHT ALSO LIKE</h3>
							<div class="might-grid">
								<div class="grid-might">
									<a href="single.html"><img src="<%=path%>/images/c-12.jpg" class="img-responsive" alt=""> </a>
								</div>
								<div class="might-top">
							...
							<div class="might-grid">
								<div class="grid-might">
									<a href="single.html"><img src="<%=path%>/images/c-10.jpg" class="img-responsive" alt=""> </a>
								</div>
								<div class="might-top">
									<h4><a href="single.html">Duis consectetur gravida</a></h4>
									<p> Nullam non magna lobortis, faucibus erat eu, consequat justo. Suspendisse commodo nibh odio.</p> 
							...
							<div class="might-grid">
								<div class="grid-might">
									<a href="single.html"><img src="<%=path%>/images/c-11.jpg" class="img-responsive" alt=""> </a>
								</div>
								<div class="might-top">
									<h4><a href="single.html">Duis consectetur gravida</a></h4>
									<p> Nullam non magna lobortis, faucibus erat eu, consequat justo. Suspendisse commodo nibh odio.</p> 
		...
		<div class="container">
			...
			<ul id="flexiselDemo3">
				...
				<li>
					<a href="#">
						<span class="banner-1">
							<img src="<%=path%>/images/s-1.jpg" class="img-responsive" alt="">
						</span>
					</a>
				</li>
				<li>
					<a href="#">
						<span class="banner-1">
							<img src="<%=path%>/images/s-2.jpg" class="img-responsive" alt="">
						</span>
					</a>
				</li>			
				<li>
					<a href="#">
						<span class="banner-1">
							<img src="<%=path%>/images/s-3.jpg" class="img-responsive" alt="">
						</span>
					</a>
				</li>		
				<li>
					<a href="#">
						<span class="banner-1">
							<img src="<%=path%>/images/s-4.jpg" class="img-responsive" alt="">
						</span>
					</a>
				</li>	
				<li>
					<a href="#">
						<span class="banner-1">
							<img src="<%=path%>/images/s-5.jpg" class="img-responsive" alt="">
						</span>
					</a>
				</li>	
				<li>
					<a href="#">
						<span class="banner-1">
							<img src="<%=path%>/images/s-6.jpg" class="img-responsive" alt="">
						</span>
					</a>
				</li>				
			</ul>
